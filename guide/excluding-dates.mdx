...
For large exclusion lists, you can import dates in bulk:

1. Prepare a CSV or JSON file with your excluded dates
2. Navigate to **Configuration** > **Import Exclusions**
3. Select your file and confirm
4. Review the imported dates in the exclusion list

<Tip>
  Share your exclusion list template across projects to maintain consistency. Export once, import everywhere.
</Tip>

### Editing and Removing Exclusions

- **Edit**: Click on any excluded date to modify the label or date
- **Remove**: Click the trash icon next to an exclusion to delete it
- **Bulk delete**: Select multiple exclusions and remove them at once
- **Temporary disable**: Toggle individual exclusions off without deleting them
